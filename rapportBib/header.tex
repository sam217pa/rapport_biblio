...
\newcommand{\allele}[2][]{%
 \tikz[baseline = -0.5ex]%
\draw[#1, fill = #1, opacity=0.5] (0, 0) circle (0.15cm) node[#1,text opacity=1,
font=\scriptsize\sffamily] {#2};%
}

\newcommand{\alg}[0]{\allele[Gray]{A}}
\newcommand{\alA}[0]{\allele[Cerulean]{A}}
\newcommand{\ala}[0]{\allele[Red]{a}}
